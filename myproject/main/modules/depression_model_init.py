...
def dm_init():
    total_data = pd.read_csv(str(settings.BASE_DIR) + '/dataset/tweets_dataset_final3.csv', encoding='cp949')
    ...
    model = load_model(str(settings.BASE_DIR) + '/model/BiLSTM_model_final3')
    max_len = 55
